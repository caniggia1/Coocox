...
int main(void) {
//	SystemInit();	// je Å¾e klican v "startup_stm32f10x_md.c"; definiran v "system_stm32f10x.c" na 72MHz(HSE)
...
//    		GPIOC->ODR ^= GPIO_Pin_13;
			...
			USART_SendData(USART1, 'a');	// ne preverja, èe je buffer prazen
			putchar('b');
//			printf("x=%d\r\n", x);	// zloži v buffer in ne pošlje dokler ne dobi '\n', èe imaš stdin buffer
			printf("x=%d\r", x);	// ne èaka na '\n', ker imam izklopljen 'stdin' buffer
			x++;
    	}
