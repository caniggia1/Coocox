...
#define SYSCLK_FREQ_HSI64MHz  64000000		//++
#endif
...
#elif defined SYSCLK_FREQ_HSI64MHz
  uint32_t SystemCoreClock         = SYSCLK_FREQ_HSI64MHz;        /*!< System Clock Frequency (Core Clock) */
